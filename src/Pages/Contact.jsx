        ...
        >
          ...
          >
            <Select placeholder="Select event type">
              ...
              <Select.Option value="sports">Sports Event</Select.Option>
              <Select.Option value="art exhibition">Art Exhibition</Select.Option>
              <Select.Option value="standup comedy">Stand-Up Comedy</Select.Option>
              <Select.Option value="food festival">Food Festival</Select.Option>
              <Select.Option value="tech conference">Tech Conference</Select.Option>
            </Select>
          </Form.Item>
